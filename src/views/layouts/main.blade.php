...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="/permissions/assets/images/favicon.png">
    <title>Matrix Template - The Ultimate Multipurpose admin template</title>
    <!-- Custom CSS -->
    <link href="/permissions/dist/css/style.min.css" rel="stylesheet">
    <link href="/permissions/assets/libs/toastr/build/toastr.min.css" rel="stylesheet">
...
<body>
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="/permissions/assets/images/logo-icon.png" alt="homepage" class="light-logo" />
                        ...
                        <span class="logo-text">
                             <!-- dark Logo text -->
                             <img src="/permissions/assets/images/logo-text.png" alt="homepage" class="light-logo" />
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <!-- ============================================================== -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="/permissions/assets/images/users/1.jpg" alt="user" class="rounded-circle" width="31"></a>
                                ...
                                <div class="modal fade" id="Modal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <img src="/permissions/assets/images/background/img5.jpg" width="100% ">
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                            </div>
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="/permissions/assets/libs/jquery/dist/jquery.min.js"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="/permissions/assets/libs/popper.js/dist/umd/popper.min.js"></script>
    <script src="/permissions/assets/libs/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- slimscrollbar scrollbar JavaScript -->
    <script src="/permissions/assets/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js"></script>
    <script src="/permissions/assets/extra-libs/sparkline/sparkline.js"></script>
    <!--Wave Effects -->
    <script src="/permissions/dist/js/waves.js"></script>
    <!--Menu sidebar -->
    <script src="/permissions/dist/js/sidebarmenu.js"></script>
    <!--Custom JavaScript -->
    <script src="/permissions/dist/js/custom.min.js"></script>
    <!-- this page js -->
    <script src="/permissions/assets/libs/toastr/build/toastr.min.js"></script>
    <script>
        $(function(){
            // Success Type
